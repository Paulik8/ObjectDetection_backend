...
def get_tag(file):
    model_file_name = '/home/paul/PycharmProjects/diplom/model_OO/frozen_inference_graph.pb'
    ...
    label_map_file_name = '/home/paul/PycharmProjects/models/research/object_detection/data/object-detection.pbtxt'
